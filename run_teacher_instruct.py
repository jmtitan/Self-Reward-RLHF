...
def run():
    ...
    generated_responses_file = args.output+ "gemini_ins_responses.jsonl"
    generated_prefer_file = args.output+ "gemini_ins_preferences.jsonl"

    Gen = Generator(args.base_model, args.model)

    Gen.generate_prompts(ift_dataset_file, generated_prompts_file)
    Gen.gemini_as_instructor(generated_prompts_file, generated_responses_file)    
    Gen.gemini_preference(generated_responses_file, generated_prefer_file)
